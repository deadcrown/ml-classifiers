...
ax[0][0].plot(range(1, len(logistic1.loss_)+1), logistic1.loss_, marker='x')
ax[0][0].set_xlabel('Epochs')
ax[0][0].set_ylabel('Log loss')
ax[0][0].set_title('Logistic GD - step:0.1 epoch:300')

ax[0][1].plot(range(1, len(logistic2.loss_)+1), logistic2.loss_, marker='x')
ax[0][1].set_xlabel('Epochs')
ax[0][1].set_ylabel('Log loss')
ax[0][1].set_title('Logistic GD - step:0.001 epoch:300')

ax[1][0].plot(range(1, len(logistic3.loss_)+1), logistic3.loss_, marker='x')
ax[1][0].set_xlabel('Epochs')
ax[1][0].set_ylabel('Log loss')
ax[1][0].set_title('Logistic GD - step:0.01 epoch:300')

ax[1][1].plot(range(1, len(logistic4.loss_)+1), logistic4.loss_, marker='x')
